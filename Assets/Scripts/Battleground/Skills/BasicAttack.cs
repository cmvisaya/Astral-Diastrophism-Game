...
public class BasicAttack : Skill
{
    ...
    void Start()
    {
        ...
        animID = 1;
        skillDescription = "A simple strike. The Daetra of this skill is always the user's base Daetra, and the base power of this skill is always the user's level.";
    }

    override public void UseSkill(Unit user, Unit target, TextMeshProUGUI dialogueText, BattleHUD hud, BattleHUD userHUD)
    {
        {
            skillDaetra = user.baseDaetra;
            skillBasePower = user.unitLevel;
            //skillBasePower = 50;
